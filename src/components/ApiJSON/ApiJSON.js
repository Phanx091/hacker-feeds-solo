...
componentDidMount() {
    ...
    .then(response => {
        ...
        console.log(`Success axios.get.API`, response);
    })
    .catch(error => {
  ...
  render() {
    ...
    return (
        <li>
          ...
          <img style={{ width: "50px", height: "50px" }} src={this.state.apiData.image} alt={this.state.apiData.description} /><br />
            {this.state.apiData.title}<br /> 
